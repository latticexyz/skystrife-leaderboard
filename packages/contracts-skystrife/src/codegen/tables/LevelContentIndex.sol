...
ResourceId constant _tableId = ResourceId.wrap(
  bytes32(abi.encodePacked(RESOURCE_TABLE, bytes14(""), bytes16("LevelContentInde")))
);
ResourceId constant LevelContentIndexTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0000000100000000000000000000000000000000000000000000000000000000
);

library LevelContentIndex {
  /**
  ...
  function getKeyNames() internal pure returns (string[] memory keyNames) {
    ...
    keyNames[0] = "levelId";
    keyNames[1] = "tableId";
    keyNames[2] = "encodedLengths";
    keyNames[3] = "staticDataHash";
    keyNames[4] = "dynamicDataHash";
  }
  ...
  function getValue(
    ...
    bytes32 staticDataHash,
    bytes32 dynamicDataHash
  ) internal view returns (uint256[] memory value) {
    bytes32[] memory _keyTuple = new bytes32[](5);
    _keyTuple[0] = levelId;
    _keyTuple[1] = ResourceId.unwrap(tableId);
    _keyTuple[2] = PackedCounter.unwrap(encodedLengths);
    _keyTuple[3] = staticDataHash;
    _keyTuple[4] = dynamicDataHash;
